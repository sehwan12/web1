...
exports.page=function(request, response){
  ...
  db.query(`SELECT * FROM topic`,function(error,topics){
        ...
        db.query(`SELECT * FROM topic LEFT JOIN author ON topic.author_id=author.id WHERE topic.id=?`,[queryData.get('id')], function(error2,topic){
          if(error2){
            throw error2;
          }
          console.log(topic);
    ...
    db.query(`SELECT * FROM topic`,function(error,topics){
        ...
        db.query(`SELECT * FROM topic WHERE id=?`,[queryData.get('id')], function(error2,topic){
          ...
          db.query(`SELECT * FROM author`, function(error2,authors){
            ...
            <p><textarea name="description">${sanitizehtml(topic[0].description)}</textarea></p>
            <p>
